...
public class MatrixI2cTransaction {
    ...
    /* renamed from: com.qualcomm.hardware.matrix.MatrixI2cTransaction.1 */
    static /* synthetic */ class C00111 {
        static final /* synthetic */ int[] f77a;

        static {
            f77a = new int[C0012a.values().length];
            try {
                f77a[C0012a.PROPERTY_MODE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f77a[C0012a.PROPERTY_START.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f77a[C0012a.PROPERTY_TIMEOUT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f77a[C0012a.PROPERTY_TARGET.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f77a[C0012a.PROPERTY_SPEED.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f77a[C0012a.PROPERTY_BATTERY.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f77a[C0012a.PROPERTY_POSITION.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f77a[C0012a.PROPERTY_MOTOR_BATCH.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f77a[C0012a.PROPERTY_SERVO.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f77a[C0012a.PROPERTY_SERVO_ENABLE.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
        }
    }

    /* renamed from: com.qualcomm.hardware.matrix.MatrixI2cTransaction.a */
    enum C0012a {
        PROPERTY_MODE,
        PROPERTY_TARGET,
        PROPERTY_SPEED,
    ...
    /* renamed from: com.qualcomm.hardware.matrix.MatrixI2cTransaction.b */
    enum C0013b {
        QUEUED,
        PENDING_I2C_READ,
        PENDING_I2C_WRITE,
    ...
    MatrixI2cTransaction(byte motor, C0012a property) {
        this.motor = motor;
        this.property = property;
        this.state = C0013b.QUEUED;
        this.write = false;
    }

    MatrixI2cTransaction(byte motor, C0012a property, int value) {
        this.motor = motor;
        this.value = value;
        this.property = property;
        this.state = C0013b.QUEUED;
    ...
    MatrixI2cTransaction(byte motor, byte speed, int target, byte mode) {
        ...
        this.target = target;
        this.mode = mode;
        this.property = C0012a.PROPERTY_MOTOR_BATCH;
        this.state = C0013b.QUEUED;
        this.write = true;
    }
    ...
    MatrixI2cTransaction(byte servo, byte target, byte speed) {
        ...
        this.speed = speed;
        this.target = target;
        this.property = C0012a.PROPERTY_SERVO;
        this.state = C0013b.QUEUED;
        this.write = true;
    }
    ...
    public boolean isEqual(MatrixI2cTransaction transaction) {
        ...
        switch (C00111.f77a[this.property.ordinal()]) {
    ...
    public String toString() {
        if (this.property == C0012a.PROPERTY_MOTOR_BATCH) {
        ...
        if (this.property == C0012a.PROPERTY_SERVO) {
        ...
        if (this.property == C0012a.PROPERTY_SERVO_ENABLE) {
