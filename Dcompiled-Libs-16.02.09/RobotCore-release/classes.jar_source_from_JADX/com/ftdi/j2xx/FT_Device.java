...
public class FT_Device {
    ...
    public FT_Device(Context parentContext, UsbManager usbManager, UsbDevice dev, UsbInterface itf) {
        this.f33t = 0;
        byte[] bArr = new byte[Telemetry.cbTagMax];
        ...
        try {
            ...
            m28c().controlTransfer(-128, 6, rawDescriptors[15] | 768, 0, bArr, Telemetry.cbTagMax, 0);
    ...
    public int read(byte[] data, int length, long wait_ms) {
        ...
        return this.f29p.m145a(data, length, wait_ms);
    }
    ...
    public short getModemStatus() {
        ...
        this.f14a &= -3;
        return (short) (this.f20g.modemStatus & Telemetry.cbTagMax);
    }
    ...
    public int getQueueStatus() {
        ...
        return this.f29p.m151c();
    }

    public boolean readBufferFull() {
        return this.f29p.m148a();
    }
    ...
    public boolean setFlowControl(short flowControl, byte xon, byte xoff) {
        ...
        if (flowControl == D2xxManager.FT_FLOW_XON_XOFF) {
            i = (short) (((short) (xoff << 8)) | (xon & Telemetry.cbTagMax));
        } else {
            i = 0;
        }
    ...
    public boolean clrDtr() {
        ...
        if (m28c().controlTransfer(64, 1, 256, this.f33t, null, 0, 0) != 0) {
            z = false;
        }
        return z;
    }
    ...
    public boolean setChars(byte eventChar, byte eventCharEnable, byte errorChar, byte errorCharEnable) {
        ...
        int i = eventChar & Telemetry.cbTagMax;
        ...
        i = errorChar & Telemetry.cbTagMax;
    ...
    public boolean setBitMode(byte mask, byte bitMode) {
        ...
        if (m28c().controlTransfer(64, 11, (bitMode << 8) | (mask & Telemetry.cbTagMax), this.f33t, null, 0, 0) != 0) {
            z = false;
        }
        return z;
    }
    ...
    public boolean setLatencyTimer(byte latency) {
        int i = latency & Telemetry.cbTagMax;
