...
class C0015h extends C0004k {
    ...
    boolean m110a(short s, short s2) {
        boolean z = false;
    ...
    short m109a(FT_EEPROM ft_eeprom) {
    ...
    FT_EEPROM m108a() {
        ...
        try {
            ...
            ft_eeprom_232r.CBus4 = (byte) (iArr[11] & Telemetry.cbTagMax);
            ft_eeprom_232r.Manufacturer = m46a(((iArr[7] & Telemetry.cbTagMax) - 128) / 2, iArr);
            ft_eeprom_232r.Product = m46a(((iArr[8] & Telemetry.cbTagMax) - 128) / 2, iArr);
            ft_eeprom_232r.SerialNumber = m46a(((iArr[9] & Telemetry.cbTagMax) - 128) / 2, iArr);
    ...
    int m107a(byte[] bArr) {
        ...
        int b = (short) (((short) ((63 - (m112b() / 2)) - 1)) & Telemetry.cbValueMax);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m111a(int i) {
        ...
        short b = (short) (((short) ((63 - (m112b() / 2)) - 1)) & Telemetry.cbValueMax);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m43a(b);
