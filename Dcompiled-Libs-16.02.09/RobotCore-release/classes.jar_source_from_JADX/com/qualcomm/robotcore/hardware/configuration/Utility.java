...
public class Utility {
    ...
    private static int f283c;
    private Activity f284a;
    private SharedPreferences f285b;
    private WriteXMLFileHandler f286d;
    ...
    static /* synthetic */ class C00411 {
        ...
        static {
            f282a = new int[DeviceType.values().length];
            try {
                f282a[DeviceType.MODERN_ROBOTICS_USB_DC_MOTOR_CONTROLLER.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f282a[DeviceType.MODERN_ROBOTICS_USB_SERVO_CONTROLLER.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f282a[DeviceType.MODERN_ROBOTICS_USB_LEGACY_MODULE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f282a[DeviceType.MODERN_ROBOTICS_USB_DEVICE_INTERFACE_MODULE.ordinal()] = 4;
    ...
    public Utility(Activity activity) {
        this.f284a = activity;
        this.f285b = PreferenceManager.getDefaultSharedPreferences(activity);
        this.f286d = new WriteXMLFileHandler(activity);
    }
    ...
    public void createConfigFolder() {
        ...
        if (!z) {
            RobotLog.m250e("Can't create the Robot Config Files directory!");
            complainToast("Can't create the Robot Config Files directory!", this.f284a);
        }
    }
    ...
    public ArrayList<String> getXMLFiles() {
        ...
        if (listFiles == null) {
            RobotLog.m252i("robotConfigFiles directory is empty");
    ...
    public boolean writeXML(Map<SerialNumber, ControllerConfiguration> deviceControllers) {
        ...
        try {
            this.f287e = this.f286d.writeXml(arrayList);
        } catch (RuntimeException e) {
            if (e.getMessage().contains("Duplicate name")) {
                complainToast("Found " + e.getMessage(), this.f284a);
                RobotLog.m250e("Found " + e.getMessage());
                return true;
            }
        }
        return false;
    ...
    public void writeToFile(String filename) throws RobotCoreException, IOException {
        this.f286d.writeToFile(this.f287e, CONFIG_FILES_DIR, filename);
    }
    ...
    public void createLists(Set<Entry<SerialNumber, DeviceType>> entries, Map<SerialNumber, ControllerConfiguration> deviceControllers) {
        for (Entry entry : entries) {
            switch (C00411.f282a[((DeviceType) entry.getValue()).ordinal()]) {
    ...
    public DeviceInterfaceModuleConfiguration buildDeviceInterfaceModule(SerialNumber serialNumber) {
        DeviceInterfaceModuleConfiguration deviceInterfaceModuleConfiguration = new DeviceInterfaceModuleConfiguration("Device Interface Module " + f283c, serialNumber);
    ...
    public LegacyModuleControllerConfiguration buildLegacyModule(SerialNumber serialNumber) {
        LegacyModuleControllerConfiguration legacyModuleControllerConfiguration = new LegacyModuleControllerConfiguration("Legacy Module " + f283c, createLegacyModuleList(), serialNumber);
        f283c++;
    ...
    public ServoControllerConfiguration buildServoController(SerialNumber serialNumber) {
        ServoControllerConfiguration servoControllerConfiguration = new ServoControllerConfiguration("Servo Controller " + f283c, createServoList(), serialNumber);
        f283c++;
        return servoControllerConfiguration;
    }

    public MotorControllerConfiguration buildMotorController(SerialNumber serialNumber) {
        MotorControllerConfiguration motorControllerConfiguration = new MotorControllerConfiguration("Motor Controller " + f283c, createMotorList(), serialNumber);
        f283c++;
    ...
    public void updateHeader(String default_name, int pref_hardware_config_filename_id, int fileTextView, int header_id) {
        String replaceFirst = this.f285b.getString(this.f284a.getString(pref_hardware_config_filename_id), default_name).replaceFirst("[.][^.]+$", BuildConfig.VERSION_NAME);
        ((TextView) this.f284a.findViewById(fileTextView)).setText(replaceFirst);
    ...
    public void saveToPreferences(String filename, int pref_hardware_config_filename_id) {
        ...
        Editor edit = this.f285b.edit();
        edit.putString(this.f284a.getString(pref_hardware_config_filename_id), filename);
        edit.apply();
    }

    public void changeBackground(int color, int header_id) {
        ((LinearLayout) this.f284a.findViewById(header_id)).setBackgroundColor(color);
    }

    public String getFilenameFromPrefs(int pref_hardware_config_filename_id, String default_name) {
        return this.f285b.getString(this.f284a.getString(pref_hardware_config_filename_id), default_name);
    }
    ...
    public void setOrangeText(String msg0, String msg1, int info_id, int layout_id, int orange0, int orange1) {
        LinearLayout linearLayout = (LinearLayout) this.f284a.findViewById(info_id);
        linearLayout.setVisibility(0);
        linearLayout.removeAllViews();
        this.f284a.getLayoutInflater().inflate(layout_id, linearLayout, true);
    ...
    public void confirmSave() {
        Toast makeText = Toast.makeText(this.f284a, "Saved", 0);
        makeText.setGravity(80, 0, 50);
        makeText.show();
    }

    public Builder buildBuilder(String title, String message) {
        Builder builder = new Builder(this.f284a);
