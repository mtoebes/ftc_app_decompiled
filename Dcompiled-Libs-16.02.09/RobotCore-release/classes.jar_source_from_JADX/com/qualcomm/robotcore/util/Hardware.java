...
public class Hardware {
    ...
    public static boolean CheckIfIFC() {
        ...
        RobotLog.m248d("Platform information: board = " + str + " brand = " + str2 + " device = " + str3 + " hardware = " + str4 + " manufacturer = " + str5 + " model = " + str6 + " product = " + str7);
        if (str.equals("MSM8960") && str2.equals("qcom") && str3.equals("msm8960") && str4.equals("qcom") && str5.equals("unknown") && str6.equals("msm8960") && str7.equals("msm8960")) {
            RobotLog.m248d("Detected IFC6410 Device!");
            return true;
        }
        RobotLog.m248d("Detected regular SmartPhone Device!");
        return false;
    }
}
