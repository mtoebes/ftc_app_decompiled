...
class C0017j extends C0004k {
    ...
    short m114a(FT_EEPROM ft_eeprom) {
    ...
    FT_EEPROM m113a() {
        ...
        if (this.a == (short) 70) {
            ...
            ft_eeprom_4232h.Product = m46a(((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_4232h.SerialNumber = m46a(((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            return ft_eeprom_4232h;
        }
        ft_eeprom_4232h.Manufacturer = m46a(i / 2, iArr);
        ft_eeprom_4232h.Product = m46a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_4232h.SerialNumber = m46a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_4232h;
    }
    ...
    int m112a(byte[] bArr) {
        ...
        int b = (short) (((this.b - (m116b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
    ...
    byte[] m115a(int i) {
        ...
        short b = (short) (((this.b - (m116b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m43a(b);
