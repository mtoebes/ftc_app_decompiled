...
class C0021o {
    ...
    public C0021o(FT_Device fT_Device) {
        ...
        this.f118e = new ByteBuffer[Command.MAX_COMMAND_LENGTH];
    ...
    C0020n m143b(int i) throws InterruptedException {
    ...
    C0020n m145c(int i) throws InterruptedException {
        this.f115b[i].acquire();
        return m139a(i);
    }

    public void m147d(int i) throws InterruptedException {
        synchronized (this.f116c) {
            this.f116c[i].m132d(i);
        }
        this.f114a[i].release();
    }

    public void m149e(int i) throws InterruptedException {
        this.f115b[i].release();
    }

    public void m140a(C0020n c0020n) throws D2xxException {
        try {
            int b = c0020n.m127b();
            if (b < 2) {
                c0020n.m125a().clear();
    ...
    private void m133b(C0020n c0020n) throws InterruptedException {
        boolean z = true;
        ByteBuffer a = c0020n.m125a();
        int b = c0020n.m127b();
        if (b > 0) {
            ...
            while (i2 < i) {
                ...
                if (i2 == i - 1) {
                    ...
                    this.f125l.f20g.lineStatus = (short) (a.get() & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST);
                    i4 = i6 + 2;
                    if (a.hasRemaining()) {
    ...
    public int m138a(byte[] bArr, int i, long j) {
    ...
    public int m146d() {
        return (this.f126m.getMaxBufferSize() - m144c()) - 1;
    }
    ...
    L_0x002c:
        ...
        throw r0;
    L_0x002f:
        r4 = r7.m139a(r0);	 Catch:{ all -> 0x002c }
        r5 = r4.m131d();	 Catch:{ all -> 0x002c }
        if (r5 == 0) goto L_0x0043;
    L_0x0039:
        r5 = r4.m127b();	 Catch:{ all -> 0x002c }
        r6 = 2;
        if (r5 <= r6) goto L_0x0043;
    L_0x0040:
        r4.m130c();	 Catch:{ all -> 0x002c }
    L_0x0043:
        r0 = r0 + 1;
        goto L_0x0023;
        */
    ...
    public int m137a(boolean z, short s, short s2) throws InterruptedException {
    ...
    public void m150f() throws InterruptedException {
