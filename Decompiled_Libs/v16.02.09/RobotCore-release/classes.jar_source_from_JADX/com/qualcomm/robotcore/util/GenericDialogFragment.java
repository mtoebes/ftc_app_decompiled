...
public class GenericDialogFragment extends DialogFragment {
    ...
    class C00531 implements OnClickListener {
        final /* synthetic */ GenericDialogFragment f376a;

        C00531(GenericDialogFragment genericDialogFragment) {
            this.f376a = genericDialogFragment;
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(string).setPositiveButton("OK", new C00531(this));
