...
public class FT_Spi_Slave extends SpiSlaveThread {
    ...
    public int write(byte[] wrBuf) {
        ...
        int a = m159a(wrBuf, 90, SPI_SLAVE_CMD.SPI_SLAVE_TRANSFER, this.f161i, length);
        ...
        bArr[5] = (byte) (length & Telemetry.cbTagMax);
        int i = 6;
        int i2 = 0;
        ...
        i = i2 + 1;
        bArr[i2] = (byte) (a & Telemetry.cbTagMax);
    ...
    private int m159a(byte[] bArr, int i, int i2, int i3, int i4) {
        int i5;
        int i6 = 0;
        if (bArr != null) {
            i5 = 0;
            while (i6 < bArr.length) {
                i5 += bArr[i6] & Telemetry.cbTagMax;
                i6++;
            }
        } else {
            i5 = 0;
        }
        return ((((i5 + i) + i2) + i3) + ((65280 & i4) >> 8)) + (i4 & Telemetry.cbTagMax);
    }

    private void m163b() {
        r6 = new byte[8];
        int a = m159a(null, 90, SPI_SLAVE_CMD.SPI_ACK, this.f156d, 0);
        r6[6] = (byte) ((65280 & a) >> 8);
        r6[7] = (byte) (a & Telemetry.cbTagMax);
        this.f162j.write(r6, r6.length, new int[1]);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m160a(byte[] r14) {
        /*
        r13 = this;
        r12 = 3;
        r11 = 0;
