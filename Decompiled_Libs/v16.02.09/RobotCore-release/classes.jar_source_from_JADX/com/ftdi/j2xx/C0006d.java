...
class C0006d extends C0004k {
    ...
    FT_EEPROM m62a() {
        ...
        if (this.a == (short) 70) {
            ...
            ft_eeprom_2232d.Product = m46a(((iArr[8] & Telemetry.cbTagMax) - 128) / 2, iArr);
            ft_eeprom_2232d.SerialNumber = m46a(((iArr[9] & Telemetry.cbTagMax) - 128) / 2, iArr);
            return ft_eeprom_2232d;
        }
        ft_eeprom_2232d.Manufacturer = m46a(i / 2, iArr);
        ft_eeprom_2232d.Product = m46a((iArr[8] & Telemetry.cbTagMax) / 2, iArr);
        ft_eeprom_2232d.SerialNumber = m46a((iArr[9] & Telemetry.cbTagMax) / 2, iArr);
        return ft_eeprom_2232d;
    }

    int m65b() {
        int a = m43a((short) 9);
        return (((this.b - 1) - 1) - ((((a & 65280) >> 8) / 2) + (a & Telemetry.cbTagMax))) * 2;
    }
