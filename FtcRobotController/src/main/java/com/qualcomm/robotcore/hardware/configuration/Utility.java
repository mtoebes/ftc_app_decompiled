...
public class Utility {
    ...
    public Utility(Activity activity) {
        ...
        this.writer = new WriteXMLFileHandler(activity);
    }
    ...
    public boolean writeXML(Map<SerialNumber, ControllerConfiguration> deviceControllers) {
        ...
        try {
            this.output = this.writer.writeXml(arrayList);
    ...
    public void writeToFile(String filename) throws RobotCoreException, IOException {
        this.writer.writeToFile(this.output, CONFIG_FILES_DIR, filename);
    }
        ...
        for (Entry entry : entries) {
            ...
            switch (deviceType) {
                case MODERN_ROBOTICS_USB_DC_MOTOR_CONTROLLER:
                    deviceControllers.put(serialNumber, buildMotorController(serialNumber));
                    break;
                case MODERN_ROBOTICS_USB_SERVO_CONTROLLER:
                    deviceControllers.put(serialNumber, buildServoController(serialNumber));
                    break;
                case MODERN_ROBOTICS_USB_LEGACY_MODULE:
                    deviceControllers.put(serialNumber, buildLegacyModule(serialNumber));
                    break;
                case MODERN_ROBOTICS_USB_DEVICE_INTERFACE_MODULE /*4*/:
                    deviceControllers.put(serialNumber, buildDeviceInterfaceModule(serialNumber));
                    break;
                default:
                    break;
            }
    ...
    public ArrayList<DeviceConfiguration> createServoList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 1; i <= ServoControllerConfiguration.SERVO_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createLegacyModuleList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < LegacyModuleControllerConfiguration.LEGACY_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createPWMList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < DeviceInterfaceModuleConfiguration.PWD_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createI2CList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < DeviceInterfaceModuleConfiguration.I2C_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createAnalogInputList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < DeviceInterfaceModuleConfiguration.ANALOG_INPUT_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createDigitalList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < DeviceInterfaceModuleConfiguration.DIGITAL_TOTAL_PORTS; i++) {
    ...
    public ArrayList<DeviceConfiguration> createAnalogOutputList() {
        ArrayList<DeviceConfiguration> arrayList = new ArrayList<DeviceConfiguration>();
        for (int i = 0; i < DeviceInterfaceModuleConfiguration.ANALOG_OUTPUT_TOTAL_PORTS; i++) {
