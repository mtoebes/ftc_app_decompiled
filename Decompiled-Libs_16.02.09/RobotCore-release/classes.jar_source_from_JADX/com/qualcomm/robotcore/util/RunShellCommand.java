...
public class RunShellCommand {
    ...
    public String run(String cmd) {
        if (this.f423a) {
            RobotLog.m254v("running command: " + cmd);
        }
        String a = m258a(cmd, false);
        if (this.f423a) {
            RobotLog.m254v("         output: " + a);
        }
        return a;
    }
    ...
    private String m258a(String str, boolean z) {
    ...
    public static void killSpawnedProcess(String processName, String packageName, RunShellCommand shell) throws RobotCoreException {
        try {
            ...
            while (spawnedProcessPid != -1) {
                RobotLog.m254v("Killing PID " + spawnedProcessPid);
