...
class C0004k {
    ...
    int m40a(byte b) throws D2xxException {
        ...
        if (a2) {
            this.f46c = true;
            if ((m43a((short) 0) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) == CHIPTOP_CMD.CHIPTOP_WRITE_OTP_TEST_BYTE) {
                m55c();
                this.f44a = (short) 70;
                this.f45b = 64;
                return 64;
            } else if ((m43a((short) 64) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) == CHIPTOP_CMD.CHIPTOP_WRITE_OTP_TEST_BYTE) {
                m55c();
                this.f44a = (short) 86;
                this.f45b = SPI_SLAVE_CMD.SPI_MASTER_TRANSFER;
                return SPI_SLAVE_CMD.SPI_MASTER_TRANSFER;
            } else if ((m43a((short) 192) & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) == CHIPTOP_CMD.CHIPTOP_WRITE_OTP_TEST_BYTE) {
                m55c();
                this.f44a = (short) 102;
                this.f45b = SPI_SLAVE_CMD.SPI_MASTER_TRANSFER;
                return Command.MAX_COMMAND_LENGTH;
