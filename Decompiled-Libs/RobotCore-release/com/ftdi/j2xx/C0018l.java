...
class C0018l extends C0004k {
    ...
    short m119a(FT_EEPROM ft_eeprom) {
    ...
    FT_EEPROM m118a() {
        ...
        fT_EEPROM_X_Series.Manufacturer = m46a((iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        fT_EEPROM_X_Series.Product = m46a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        fT_EEPROM_X_Series.SerialNumber = m46a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
    ...
    int m117a(byte[] bArr) {
        ...
        int b = (short) (((this.b - (m121b() / 2)) - 1) - 1);
        int i = 0;
        while (i < bArr.length) {
            int i2;
            if (i + 1 < bArr.length) {
        ...
        if (iArr[1] == 0 || iArr[2] == 0 || !m122b(iArr, this.b - 1)) {
            return 0;
        }
        return bArr.length;
    }
    ...
    byte[] m120a(int i) {
        ...
        short b = (short) (((this.b - (m121b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m43a(b);
