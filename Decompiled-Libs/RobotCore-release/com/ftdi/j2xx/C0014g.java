...
class C0014g extends C0004k {
    ...
    short m97a(FT_EEPROM ft_eeprom) {
    ...
    FT_EEPROM m96a() {
        ...
        ft_eeprom_232h.Manufacturer = m46a((iArr[7] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_232h.Product = m46a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_232h.SerialNumber = m46a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_232h;
    }
    ...
    byte[] m98a(int i) {
        ...
        short b = (short) (((this.b - (m99b() / 2)) - 1) - 1);
        int i2 = 0;
        while (i2 < i) {
            short s = (short) (b + 1);
            int a = m43a(b);
