...
class C0005c extends C0004k {
    ...
    FT_EEPROM m57a() {
        ...
        if (this.a == (short) 70) {
            ...
            ft_eeprom_2232h.Product = m46a(((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            ft_eeprom_2232h.SerialNumber = m46a(((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) - 128) / 2, iArr);
            return ft_eeprom_2232h;
        }
        ft_eeprom_2232h.Manufacturer = m46a(i / 2, iArr);
        ft_eeprom_2232h.Product = m46a((iArr[8] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        ft_eeprom_2232h.SerialNumber = m46a((iArr[9] & FT_4222_Defines.CHIPTOP_DEBUG_REQUEST) / 2, iArr);
        return ft_eeprom_2232h;
    }
